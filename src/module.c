...
# endif
    ...
    insint_c(d, "SSL_ENABLE_TICKET", CURLOPT_SSL_ENABLE_TICKET);
    insint_c(d, "SSL_CERT_COMPRESSION", CURLOPT_SSL_CERT_COMPRESSION);
    insint_c(d, "SSL_SIG_HASH_ALGS", CURLOPT_SSL_SIG_HASH_ALGS);
    insint_c(d, "HTTP2_PSEUDO_HEADERS_ORDER", CURLOPT_HTTP2_PSEUDO_HEADERS_ORDER);
    insint_c(d, "HTTPBASEHEADER", CURLOPT_HTTPBASEHEADER);
#endif
